package com.desenvolvimento.bookstoremanager.exception;
...
@ControllerAdvice
public class BoostoreExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<Object> handleEntityExistsException(EntityNotFoundException exception) {
        return buildResponseEntity(
